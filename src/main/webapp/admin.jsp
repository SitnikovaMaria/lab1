        ...
        <ul>
            <li>
                ...
                <ul>
                    ...
                    <li><a href="plan.jsp">План библиотеки</a></li>
...
<div id='content' class="content">
    ...
    <ul class="pixel-content" id="two-tab">
        ...
        <div class="content-tab">
            ...
            <div class="forminoneline">
                <form method="post" action="ImportCopy">
                    <img src="import.jpg" height="15"> <input type="submit" value="Загрузить">
                </form>
            </div>
            <div class="forminoneline">
                <form method="post" action="ExportCopy">
                    <img src="export.jpg" height="15"> <input type="submit" value="Сохранить">
                </form>
            </div>
            <div id="add">
                <a href="#win2">
            ...
            <table cols="7" width="100%" id="tab" style="margin-top: 0px;">
                ...
                <tr>
                    ...
                    <td><div id="change">
                        ...
                        <form method="post" action="ExportOneCopy">
                            <input type="hidden" value="<%out.print(copy.getInventoryNumber());%>" name="id">
    ...
    <ul class="pixel-content" id="three-tab">
        ...
        <div class="content-tab">
            ...
            <div class="forminoneline">
                <form method="post" action="ImportPublisher">
                    <img src="import.jpg" height="15"> <input type="submit" value="Загрузить">
                </form>
            </div>
            <div class="forminoneline">
                <form method="post" action="ExportPublisher">
                    <img src="export.jpg" height="15"> <input type="submit" value="Сохранить">
                </form>
            </div>
            <div id="add">
                ...
                <table cols="7" width="100%" id="tab" style="margin-top: 0px;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="post" action="ExportOnePublisher">
