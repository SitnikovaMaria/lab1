    ...
    <div id='headerLeft' class="headerLeft">
        <ul>
            <li>
                ...
                <ul>
                    <li><a href="catalogsU.html">Каталоги</a></li>
            ...
            <div style="overflow-y:scroll !important; width: 1200px; height: 340px; margin:auto;">
                <table cols="7" width="100%" id="tab" style="margin-top: 0px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="TakeCopy">
                                <input type="hidden" value="<%out.print(copy.getInventoryNumber());%>" name="inventoryNumber">
                                <img src="add.png" height="15"> <input type="submit" value="Взять">
                            </form>
                            <form method="post" action="ReplaceCopy">
                                <input type="hidden" value="<%out.print(copy.getInventoryNumber());%>" name="inventoryNumber">
                                <input type="hidden" value="<%out.print(copy.getIdUser());%>" name="idUser">
                                <img src="delete.png" height="15"> <input type="submit" value="Вернуть">
                            </form>
                        </td>
                    </tr>
                    <% }
