		...
		<ul class="pixel-content" id="one-tab">
				...
				<a href="#x" class="overlay1" id="win1"></a>
   				<div class="popup">
					...
					<div id="act">
						<p1>Название</p1><input type="text" name="name">
					</div>
					<div id="act">
						<p1>Авторы</p1><input type="text" name="authors">
					</div>
					<div id="act">
						<p1>Год</p1><input type="text" name="year">
					</div>
					<div id="act">
						<p1>Страницы</p1><input type="text" name="pages">
					</div>
					<div id="act">
						<p1>Каталог</p1>
             ...
             %>            
            						<option value="<%out.print(catalog.getName());%>"><%out.print(catalog.getName());%></option>            						
                                                        <% }
             %>
						</select>
					</div>
					<div id="act">                                            
						...
						<select style="width:165px;" tabindex="1" name="publisher">
							<option disabled>Выберите издательство</option>
            						...
            						<option value="<%out.print(publisher.getName());%>"><%out.print(publisher.getName());%></option>            						
                                                        <% }
%>
						</select>
					</div>
				...
				<table cols="7" width="100%" id="tab" style="margin-top: 0px;">
					<tr>
						...
						<td><p1>Издательство</p1></td><td><p1>Действие</p1></td>
					</tr>
		...
		<ul class="pixel-content" id="two-tab">
			...
			<div class="content-tab">
				...
				<div id="add">
					<a href="#win2"><button><img src="add.png" height="15">Добавить</button></a>
				</div>
             ...
             %>
            						...
            						<option value="<%out.print(book.getIdBook());%>"><%out.print(book.getIdBook());%></option>            						
                                                        <% }
             %>
						</select>
					</div>
             ...
             %>
            						...
            						<option value="<%out.print(user.getName());%> <%out.print(user.getLastName());%> <%out.print(user.getMiddleName());%>"><%out.print(user.getLastName());%> <%out.print(user.getName());%> <%out.print(user.getMiddleName());%></option>            						
                                                        <% }
             %>
						</select>
					</div>
		...
		<ul class="pixel-content" id="three-tab">
			...
			<div class="content-tab">
				...
				<div id="add">
					<a href="#win3"><button><img src="add.png" height="15">Добавить</button></a>
				</div>
				<a href="#x" class="overlay3" id="win3"></a>				
   				<div class="popup">
					...
					<div id="act">
						<p1>Адрес</p1><input type="text" name="address">
					</div>
					<div id="act">
						<p1>Почта</p1><input type="text" name="mail">
					</div>
					</br>
					<input type="submit" value="Принять">  
    					<a class="close" title="Закрыть" href="#close"></a>
							...
							<a href="#win3">
								<button><img src="change.png" height="15">Изменить</button>
                                                        ...
                                                        <form method ="post" action="DeletePublisher" >
                                                                <input type="hidden" value="<%out.print(publisher.getIdPublisher());%>" name="id">
                                                                <img src="delete.png" height="15">  <input type="submit" value="Удалить"> 
                                                        </form>
						</td>
             </tr>  
